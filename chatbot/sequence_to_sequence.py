...
class SequenceToSequence(object):
    ...
    def __init__(self,
                 ...
                 mode='train',  #取值为train，代表训练模式，取值为decode,代表预训练模式
                 hidden_units=256,  #RNN模型地中间层大小，encoder和decoder层相同
                 depth=1,   #encoder和decoder层地RNN层数
                 beam_width=0,  #beamsearch的超参数，用于解码
                 cell_type='lstm',  #RNN的神经元类型，lstm/gru
                 dropout=0.2,   #随机丢弃数据的比例，[0,1]
                 ...
                 max_decode_step=None,  #最大decode长度
